  ...
  return createPortal(
    (
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="host-edit-success-title"
      >
        <div className="bg-white dark:bg-zinc-900 max-w-md w-full rounded-2xl p-8 text-center shadow-2xl border border-outline-variant/10 dark:border-zinc-700">
          ...
          <h2 id="host-edit-success-title" className="text-3xl font-headline font-extrabold text-primary dark:text-green-400 mb-3">
            Changes Saved
          </h2>
