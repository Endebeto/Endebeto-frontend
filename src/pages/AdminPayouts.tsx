        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
          ...
          <div className="bg-white dark:bg-[#2d3133] rounded-2xl shadow-sm min-w-0">
            <div className="px-6 py-4 bg-surface-container-low/50 border-b border-outline-variant/10">
              ...
              <p className="text-xs text-on-surface-variant mt-1">
                Paid and failed withdrawals — each payout is a separate row and
                stays here when the host requests again.
              </p>
            </div>
                        ...
                        historyPaginated.map((wr) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-5 py-4 whitespace-nowrap">
                                <span
                                  className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold ${STATUS[st].pill}`}
                                >
                                  <span
                                    className={`w-1.5 h-1.5 rounded-full ${STATUS[st].dot}`}
                                  />
                                  {STATUS[st].label}
                                </span>
                                {wr.failureReason && (
          ...
          <div className="bg-white dark:bg-[#2d3133] rounded-2xl shadow-sm min-w-0">
            <div className="px-6 py-4 bg-surface-container-low/50 border-b border-outline-variant/10">
              ...
              <p className="text-xs text-on-surface-variant mt-1">
                Pending transfers awaiting mark paid or failed. New requests
                appear here without replacing past history.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pb-6">
            <div className="bg-surface-container-low/60 p-5 rounded-2xl border border-outline-variant/10">
              <h4 className="font-headline font-bold text-sm text-primary flex items-center gap-1.5 mb-2">
                <Lightbulb className="h-4 w-4 text-on-tertiary-container" />{" "}
                Admin Tip
              </h4>
              <p className="text-xs text-on-surface-variant leading-relaxed">
                Payouts marked as "Paid" are final and deduct from the host's
                pending balance. "Failed" payouts return the amount to the
                host's available balance automatically. Always verify bank
                details before marking paid.
              </p>
            </div>
            <div className="bg-primary-container p-5 rounded-2xl flex items-center justify-between gap-4 shadow-md">
              <div>
                ...
                <p className="text-xs text-white/75 mt-0.5">
                  Contact the financial operations team for complex bank
                  reconciliation.
                </p>
              </div>
